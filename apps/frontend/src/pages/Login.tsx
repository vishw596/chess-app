...
export const Login = () => {
    ...
    return (
        <AuthWrapper title="Welcome Back" showNavbar>
            {error && (
                <motion.div 
            ...
            >
                ...
                <span className="text-center text-xs uppercase tracking-wider text-textMuted">or continue with</span>
                <span className="w-1/5 border-t border-borderColor lg:w-1/4"></span>
            </motion.div>
            ...
            >
                ...
                <Link to={"/signup"} className="ml-1 font-medium text-white transition hover:text-[#d9d9d4] hover:underline">
                    Sign up
                </Link>
            </motion.p>
        </AuthWrapper>
